...
export const translations = {
  en: {
    ...
    heroTagline: "A personal screening room for ratings, long-form reviews and cinematic memories.",
    viewMode: "Review view",
    shelfView: "Shelf",
    deckView: "Deck",
    compactView: "Grid",
    sortReviews: "Sort reviews",
    relevanceSort: "Relevance",
    searchFilterPaused: "Search results are ranked by relevance; filters and sorting are paused.",
    ...
    synopsis: "Synopsis",
    review: "Review",
    aiDirectorsCut: "AI-generated suggestions",
    ...
    reviewNotFoundTitle: "Review Not Found",
    reviewNotFoundDesc: "This review may have been deleted or the link is invalid.",
    backToFeed: "Back to the collection",
    emotion: "Emotion",
    pacing: "Pacing",
    acting: "Acting",
    ...
    story: "Story",
    scoreMethod: "How this score is calculated",
    scoreMethodMovie: "Entertainment is the average of Emotion and Pacing. Cinematic is the average of Acting, Cinematography, Soundtrack and Story when present. Total = ⅓ Entertainment + ⅔ Cinematic.",
    scoreMethodSeries: "A manual overall score is used when set; otherwise the total is the average of each season’s rated-episode average.",
    ...
    totalReviews: "Reviews Collected",
    ...
    movieSearchLabel: "Search films, series or anime (TMDB)",
    movieSearchPlaceholder: "Enter a title...",
    movieSearchLoading: "Searching TMDB",
    movieSearchResults: "search results",
    notAvailable: "N/A",
    unknownYear: "Unknown year",
    shelfHint: "Tap a spine to pull it out, then choose Read Review.",
    dismissHint: "Dismiss shelf tip",
    shelfBrowseHint: "← Swipe sideways to browse · tap a spine to pull it out →",
    pullFromShelf: "Pull from shelf",
    shelfDialogTitle: "Review preview",
    closePreview: "Close preview",
    shelfDragHint: "Drag to turn the case, or open the full review.",
    loadingReviews: "Loading movie reviews",
    feedErrorTitle: "The collection is unavailable",
    feedErrorDesc: "The server may still be waking up. Wait a moment and try again.",
    retry: "Try again",
    noReviewsTitle: "No reviews yet",
    noReviewsDesc: "The collection is empty for this filter.",
    reviewResults: "Movie review results",
    lastWatched: "Last watched",
    noWatchDate: "No watch date",
    loading: "Loading…",
    anonymous: "Anonymous",
    // New Features
    aiTldr: "AI TL;DR",
    ...
    statsYearLabel: "Viewing year",
    statsMonthLabel: "Viewing month",
    statsLoadError: "Statistics are unavailable",
    statsLoadErrorDesc: "The collection could not be loaded, so no totals are shown.",
    timelineTableCaption: "Monthly viewing counts",
    timelineSummary: "Monthly viewing timeline",
  ...
  zh: {
    ...
    title: "片名 A → Z",
    addReview: "新增影評",
    heroTagline: "一間收藏評分、長篇影評與觀影記憶的私人電影室。",
    viewMode: "影評瀏覽方式",
    shelfView: "書牆",
    deckView: "疊卡",
    compactView: "網格",
    sortReviews: "影評排序",
    relevanceSort: "相關性",
    searchFilterPaused: "搜尋結果依相關性排列；類型與排序暫停套用。",
    ...
    deleteReview: "🗑️ 刪除影評",
    readReview: "閱讀影評",
    reviewNotFoundTitle: "找不到這篇影評",
    reviewNotFoundDesc: "這篇影評可能已刪除，或連結有誤。",
    backToFeed: "回到片庫",
    emotion: "情感共鳴",
    pacing: "節奏與剪輯",
    acting: "演員表現",
    ...
    story: "故事劇本",
    scoreMethod: "評分如何計算",
    scoreMethodMovie: "娛樂指標為情感共鳴與節奏剪輯的平均；藝術指標為演員、攝影、配樂與故事（若有）的平均。總分 = ⅓ 娛樂指標 + ⅔ 藝術指標。",
    scoreMethodSeries: "若有手動設定總評分則優先採用；否則取各季「已評分集數平均」的平均值。",
    publishedDate: "發表",
    minutesShort: "分鐘",
    minuteRead: "分鐘閱讀",
    edited: "已編輯",
    ...
    movieSearchLabel: "搜尋電影、影集或動漫（TMDB）",
    movieSearchPlaceholder: "輸入作品名稱…",
    movieSearchLoading: "正在搜尋 TMDB",
    movieSearchResults: "筆搜尋結果",
    notAvailable: "無圖片",
    unknownYear: "年份未知",
    shelfHint: "點一下書脊抽出片盒，再選「閱讀影評」。",
    dismissHint: "關閉書牆提示",
    shelfBrowseHint: "← 左右滑動瀏覽 · 點一下書脊抽出片盒 →",
    pullFromShelf: "從書牆抽出",
    shelfDialogTitle: "影評預覽",
    closePreview: "關閉預覽",
    shelfDragHint: "拖曳可轉動片盒，或直接開啟完整影評。",
    loadingReviews: "正在載入影評",
    feedErrorTitle: "目前連不上片庫",
    feedErrorDesc: "伺服器可能仍在喚醒中，請稍候再試。",
    retry: "再試一次",
    noReviewsTitle: "目前沒有影評",
    noReviewsDesc: "這個篩選條件下尚無收藏作品。",
    reviewResults: "影評搜尋結果",
    lastWatched: "最後觀看",
    noWatchDate: "尚無觀看日期",
    loading: "載入中…",
    anonymous: "匿名",
    ...
    mostWatched: "重複觀看最多",
    statsYearLabel: "觀影年份",
    statsMonthLabel: "觀影月份",
    statsLoadError: "暫時無法載入統計",
    statsLoadErrorDesc: "片庫資料未成功載入，因此不顯示可能錯誤的 0 筆統計。",
    timelineTableCaption: "每月觀影次數",
    timelineSummary: "每月觀影時間線",
