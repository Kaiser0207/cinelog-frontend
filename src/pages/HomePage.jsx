    ...
    >
      ...
      {isAdmin && (
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className="group fixed bottom-[calc(4.25rem+env(safe-area-inset-bottom,0px)+1rem)] md:bottom-6 right-7 md:right-6 z-[110] w-14 h-14 rounded-lg cursor-pointer shadow-lg overflow-hidden"
          >
